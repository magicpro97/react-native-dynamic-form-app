...
export const businessValidators = {
  ...
  validateAge: (
    age: string | number | boolean | File | null,
    formState: FormState
  ) => {
  ...
  validateSalary: (
    salary: string | number | boolean | File | null,
    formState: FormState
  ) => {
  ...
  validateDateRange: (
    endDate: string | number | boolean | File | null,
    formState: FormState
  ) => {
  ...
  validateSignature: (
    signature: string | number | boolean | File | null,
  ...
  },
  {
    ...
    validation: [
      ...
      },
      {
        ...
        validator: value =>
          value ? validators.positiveNumber(String(value)) : false,
      },
    ],
